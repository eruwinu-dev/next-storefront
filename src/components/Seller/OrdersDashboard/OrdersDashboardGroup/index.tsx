...
import OrdersDashboardGroupDropdown from "./OrdersDashboardGroupDropdown"
import OrdersDashboardGroupItem from "./OrdersDashboardGroupItem"

type Props = {
    orders: CompleteCart[]
}

const OrdersDashboardGroup = ({ orders }: Props) => {
...
export default OrdersDashboardGroup
